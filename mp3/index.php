...
<div id="main">
	...
	<div id="footer">
        <div class="adv_footer">
            ...
            <div class="gop-y"><a target="_blank" href="http://facebook.com/dung"><img title="Mọi ý kiến của bạn sẽ được trả lời qua facebook" src="image/giaodien/gopy0000.jpg" border="0"></a><!--form qua form góp ý(cái này chưa làm)-->
            </div>
        </div>
	</div>
</div>
