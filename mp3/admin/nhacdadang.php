		...
		{	
			if($_POST['sua'])	
			{
				...
				else
				{
                    ...
                    foreach ($checkbox as $key => $v_id) {
                        $tenbaihat = $_POST['tenbaihat'.$v_id];
                        $casy       = $_POST['casy'.$v_id];
                        $query = "update baihat set tenbaihat='$tenbaihat', casy='$casy' where id = $v_id";
			...
			if($_POST['no'])
			{
				...
				else
				{
					...
					echo 'Đã Xóa Thành Công : <b>'.count($checkbox).' bài hát</b>';
				}
			}
	?>
        <div class="workplace">                         
                        ...
                        <table cellpadding="0" cellspacing="0" width="100%" class="table" id="tSortable">
							...
							?>
                                <tr>
                                    ...
                                    <td><input type="text" class="span12" name="tenbaihat<?=$row['id']?>" value="<?php echo $row['tenbaihat']; ?>"></td>
                                    <td><input type="text" class="span12" name="casy<?=$row['id']?>" value="<?php echo $row['casy']; ?>"></td>
